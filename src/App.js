  ...
  return (
    <div className="mx-8 mt-4">
      ...
      <div className="">
        ...
        <div className="flex flex-wrap justify-center items-start">
          <h4 className="p-2 h-48 text-2xl border-b-2 border-black rounded-lg">LifeBand</h4>
          <div className="m-2 w-48 border-t border-l border-r border-black rounded-lg">
            
          </div>
          
          <h4 className="p-2 h-48 text-2xl border-b-2 border-black rounded-lg">React Here, Tryna Function</h4>
          <h4 className="p-2 h-48 text-2xl border-b-2 border-black rounded-lg">Tic-Tac-Toe</h4>
          <h4 className="p-2 h-48 text-2xl border-b-2 border-black rounded-lg">Pig Latin</h4>
          <h4 className="p-2 h-48 text-2xl border-b-2 border-black rounded-lg">Blog App</h4>
        </div>
      </div>

      <footer className="px-2 text-sm flex justify-center">Designed and built by Bach Diep using React.js and Tailwind CSS</footer>
    </div>
  )
}
